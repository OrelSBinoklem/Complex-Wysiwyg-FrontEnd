    ...
    var generatorCode__TabsCopyInsert = function($container, options) {
        ...
        this.loadGenerator = function( folder ) {
            ...
            $.ajax({
                ...
                type: "POST",
                cache: false,
                data: ({module: 'getfile', dir: "sb-generators/" + folder + "/" + "copy.js", text_encoding: shablonizator.textEncodingServer}),
                async: false,
            ...
            $.ajax({
                ...
                type: "POST",
                cache: false,
                data: ({module: 'getfile', dir: "sb-generators/" + folder + "/" + "insert.js", text_encoding: shablonizator.textEncodingServer}),
                async: false,
                success: function(data){
                    if(data != 'error_getfile_shablonizator156418546585415')
                    {
            ...
            $.ajax({
                url: 'sb/php/loader_generators.php',
                type: "POST",
                cache: false,
                data: transfer,
                async: false,
