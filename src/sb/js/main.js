...
$(document).ready(function(){
    ...
    //Добавляем страницу
        ...
        pageManagerVisualizatorFileManager = $('.pp__file-navigator').fileManager('sb/raskritie_papki_pixel_perfect.xml');
...
$(document).ready(function(){
    var gcmf__fileManager = $('#gc-filemanager').fileManager('sb/raskritie_papki_gc.xml');
    var gctci__fileManager = $('#gc-filemanager-insert-files').fileManager('sb/raskritie_papki_gc_insert_files.xml');
    ...
    generatorCode = new modules.generatorCode($('.gc-wrap'), {
        ...
        basePathGenerators: "sb-generators/",
    ...
    $.ajax({
        ...
        type: "POST",
        cache: false,
        data: ({module: 'getfile', dir: "sb-generators/generator-code.xml", text_encoding: 'UTF-8'}),
        async: false,
